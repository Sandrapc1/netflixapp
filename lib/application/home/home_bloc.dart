...
import 'package:netflix_project/domain/hot_and_new_resp/hot_and_new_service.dart';
...
class HomeBloc extends Bloc<HomeEvent, HomeState> {
  ...
  HomeBloc(this._homeService) : super(HomeState.intial()) {
    ...
    on<GetHomeScreenData>((event, emit) async {
      ...
      final _state1 = _movieResult.fold((MainFailure faliure) {
        return HomeState(
      ...
      final _state2 = _tvResult.fold((MainFailure faliure) {
        return HomeState(
          stateIid: DateTime.now().millisecondsSinceEpoch.toString(),
          pastYearMovieList: [],
          trendingMovieList: [],
